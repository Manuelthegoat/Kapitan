    ...
    const fetchData = async () => {
      try {
        ...
        if (startDate && endDate) {
          ...
          apiUrl = `https://kapitanlands-8xjj.onrender.com/api/v1/loans/by-payment-date?startDate=${startDate}&endDate=${endDate}`;
        } else {
          // If start and end dates are not provided, fetch all data
          apiUrl = "https://kapitanlands-8xjj.onrender.com/api/v1/loans";
        }
      ...
      if (result.isConfirmed) {
        ...
        try {
          const response = await fetch(
            `https://kapitanlands-8xjj.onrender.com/api/v1/loans/${loanId}`,
            {
              method: "DELETE",
              headers: {
