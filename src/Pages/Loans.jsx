...
const Loans = () => {
  ...
  useEffect(() => {
    ...
    fetch(
      `https://kapitanlands.onrender.com/api/v1/loans/total-deposit-amount-by-cash?startDate=${startDate}&endDate=${endDate}`,
      {
        headers: {
  ...
  useEffect(() => {
    ...
    fetch(`https://kapitanlands.onrender.com/api/v1/loans/bank/recieved`, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    })
