...
const Savings = () => {
    ...
    const fetchData = async () => {
      ...
      try {
        const response = await fetch(
          `https://kapitanlands-8xjj.onrender.com/api/v1/transactions/totalDepositByCashByPaymentDate?startDate=${startDate}&endDate=${endDate}`, {
            headers: {
  ...
  useEffect(() => {
    ...
    fetch(
      `https://kapitanlands-8xjj.onrender.com/api/v1/transactions/totalDepositByCashByPaymentDate?startDate=2010-01-01&endDate=2050-01-01`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      }
  ...
  useEffect(() => {
    fetch(
      `https://kapitanlands-8xjj.onrender.com/api/v1/transactions/totalWithdrawalsByTransferByPaymentDate?startDate=${startDate}&endDate=${endDate}`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      }
  ...
  useEffect(() => {
    fetch(
      `https://kapitanlands-8xjj.onrender.com/api/v1/transactions/totalWithdrawalsByCashByPaymentDate?startDate=${startDate}&endDate=${endDate}`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      }
  ...
  useEffect(() => {
    ...
    fetch(
      `https://kapitanlands-8xjj.onrender.com/api/v1/transactions/totalDepositByTransferByPaymentDate?startDate=${startDate}&endDate=${endDate}`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      }
  ...
  useEffect(() => {
    fetch(
      `https://kapitanlands-8xjj.onrender.com/api/v1/transactions/totalDepositByTransferByPaymentDate?startDate=2010-01-01&endDate=2050-01-01`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      }
