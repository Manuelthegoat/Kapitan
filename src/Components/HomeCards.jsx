...
const HomeCards = () => {
  ...
  useEffect(() => {
    fetch(
      "https://kapitanlands-8xjj.onrender.com/api/v1/transactions/withdrawalsByPaymentDate?startDate=2000-10-01&endDate=2099-10-31",
      {
        headers: {
          Authorization: `Bearer ${token}`,
        },
  ...
  useEffect(() => {
    fetch(
      "https://kapitanlands-8xjj.onrender.com/api/v1/transactions/totalDepositByCashByPaymentDate?startDate=2023-01-01&endDate=2029-12-31",
      {
        headers: {
          Authorization: `Bearer ${token}`,
        },
  ...
  useEffect(() => {
    fetch(
      "https://kapitanlands-8xjj.onrender.com/api/v1/transactions/totalDepositByTransferByPaymentDate?startDate=2023-01-01&endDate=2029-12-31",
      {
        headers: {
          Authorization: `Bearer ${token}`,
        },
  ...
  useEffect(() => {
    fetch(
      `https://kapitanlands-8xjj.onrender.com/api/v1/transactions/totalWithdrawalsByTransferByPaymentDate?startDate=2023-01-01&endDate=2029-12-31`,
      {
        headers: {
          Authorization: `Bearer ${token}`,
        },
  ...
  useEffect(() => {
    fetch(
      `https://kapitanlands-8xjj.onrender.com/api/v1/transactions/totalWithdrawalsByCashByPaymentDate?startDate=2023-01-01&endDate=2029-12-31`,
      {
        headers: {
          Authorization: `Bearer ${token}`,
        },
